...
class Login(models.Model):
    ...
    def getDatosSesion(IDUSUARIO):
        ...
        with connection.cursor() as cursor:
            ...
            #json_output = json.dumps(list_of_dictionaries, indent=4, default=json_serial)
            
            datin = {'data': list_of_dictionaries[0],'message': 'Se a listado correctamente', 'success': True}
            return datin
...
class Opinion(models.Model):
    idopinion = models.AutoField(db_column='IDOPINION', primary_key=True)
    ...
    descripcion = models.CharField(db_column='DESCRIPCION', max_length=445, blank=True, null=True)
    valoracion = models.DecimalField(db_column='VALORACION', max_digits=2, decimal_places=0, blank=True, null=True)
    ...
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, db_column='opinion_type', blank=True, null=True)
    object_id = models.PositiveIntegerField(db_column='opinion_id', blank=True, null=True)
    opinionable = GenericForeignKey('content_type', 'object_id')
...
class Usuario(models.Model):
    ...
    descripcion = models.CharField(db_column='DESCRIPCION', max_length=150, blank=True, null=True)  # Field name made lowercase.
    idpersona = models.ForeignKey(Persona, models.DO_NOTHING, db_column='IDPERSONA')  # Field name made lowercase.
    idusuariocreacion = models.IntegerField(db_column='IDUSUARIOCREACION')  # Field name made lowercase.
