#Claves RSA ya existen. No se regeneran.
...
class ArchivoFirma(models.Model):
    idarchivo = models.OneToOneField(Archivo, models.DO_NOTHING, db_column='IDARCHIVO', primary_key=True)  # Field name made lowercase. The composite primary key (IDARCHIVO, IDPERSONA) found, that is not supported. The first column is selected.
